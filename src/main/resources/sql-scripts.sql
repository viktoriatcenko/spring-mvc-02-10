...
insert into item ( name, person_id) values ('TV', 4);
insert into item( name, person_id) values ('Car', 4);
insert into item( name, person_id) values ('Iphone', 3);
insert into item( name, person_id) values ('Boombox', 5);
insert into item( name, person_id) values ('Ipod', 3);
...
INSERT INTO Actor_Movie VALUES(4, 7);
